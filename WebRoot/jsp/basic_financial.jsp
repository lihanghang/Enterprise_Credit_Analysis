...
columnar1.showLoading();    //数据加载完之前先显示一段简单的loading动画
 //ajax异步请求数据
    ...
    $.ajax({
        type: 'get',  
        url: './financial?name='+getParam('name'),//请求数据的地址
...
//ajax异步请求数据
   ...
   $.ajax({
       type: 'get',  
       url: './operation?name='+getParam('name'),//请求数据的地址
       dataType: "json",//返回数据形式为json
       success: function (data){
...
//ajax异步请求数据
 ...
 $.ajax({
     type: 'get',  
     url: './profit?name='+getParam('name'),//请求数据的地址
     dataType: "json",//返回数据形式为json
     success: function (data){
...
$.ajax({
   type: 'get',  
   url: './debt?name='+getParam('name'),//请求数据的地址
   dataType: "json",//返回数据形式为json
   success: function (data){
...
$.ajax({
 type: 'get',  
 url: './otherFinancial?name='+getParam('name'),//请求数据的地址
 dataType: "json",//返回数据形式为json
 success: function (data){
