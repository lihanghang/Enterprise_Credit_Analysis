...
public static void main(String[] args) throws FileNotFoundException, IOException {
	 ...
	 * 信用模型调用
	 */
	TensorFlowInferenceInterface tfi = new TensorFlowInferenceInterface("D://java-project/enterpriseInfo/TFModel/CreditModel/cnn.pb","dataType");
...
//            //导入图
//            byte[] graphBytes = IOUtils.toByteArray(new FileInputStream(System.getProperty("user.dir")+"/TFModel/Risk/经营力.pb"));
