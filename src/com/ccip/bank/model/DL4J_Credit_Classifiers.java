 ...
 * @project DL4J Credit_Classifiers
 * @author Mason
 *
 */
public class DL4J_Credit_Classifiers {
    ...
    public static void main(String[] args) throws Exception{
    		...
    		double learningRate = 0.002; //学习率   		
    		//Number of epochs (full passes of the data)
            int nEpochs = 1000;
            int numInputs = 6;  //input layer
            int numOutputs = 5; //output layer
            int numHiddenNodes = 20; //hideen layer
		    ...
		    MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
		                .seed(seed)
		                .updater(new Nesterovs(learningRate, 0.6))
		                .list()
		                .layer(0, new DenseLayer.Builder().nIn(numInputs).nOut(6)
		                        .weightInit(WeightInit.NORMAL)
		                        .activation(Activation.TANH)		              
		                        .build())
		                .layer(1, new DenseLayer.Builder().nIn(6).nOut(5)
		                        .weightInit(WeightInit.RELU)
		                        .activation(Activation.TANH)		              
		                        .build())	
		                .layer(2, new DenseLayer.Builder().nIn(5).nOut(4)
		                        .weightInit(WeightInit.RELU)
		        ...
		        model.init();
		        model.setListeners(new ScoreIterationListener(15));    //Print score every 10 parameter updates
