...
public class financialRiskBean {
		...
		/**
		 * @param flowAssertRate the flowAssertRate to set
		 */
		...
		/**
		 * @param flowPercent the flowPercent to set
		 */
		...
		/**
		 * @param allAsserrtIncrease the allAsserrtIncrease to set
		 */
		...
		public String toString() {
			return "financialRiskBean [flowAssertRate=" + flowAssertRate
					+ ", checkRate=" + checkRate + ", creditGrade="
					+ creditGrade + ", financialCostRate=" + financialCostRate
